...
namespace Phalcon\Incubator\Avatar;
...
class Gravatar implements Avatarable
{
     ...
     * @type string
     */
    private const HTTP_URL  = 'http://www.gravatar.com/avatar/';

    /**
     * The secure gravatar service URL
     * @type string
     */
    private const HTTPS_URL = 'https://secure.gravatar.com/avatar/';

    /**
     * The minimum size allowed for the Gravatar
     * @type int
     */
    public const MIN_AVATAR_SIZE = 0;

    /**
     * The maximum size allowed for the Gravatar
     * @type int
     */
    public const MAX_AVATAR_SIZE = 2048;
